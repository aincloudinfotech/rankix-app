/**
 * Brand-specific OAuth provider icons.
 * Minimal monochrome SVGs that work cleanly inside buttons.
 */
...
export function GoogleIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18a10.985 10.985 0 0 0 0 9.86l2.83-2.2 2.83-.64z"/>
